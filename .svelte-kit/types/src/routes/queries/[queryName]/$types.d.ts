...
type RouteParams = { queryName: string }
type RouteId = '/queries/[queryName]';
...
type LayoutRouteId = RouteId | "/queries/[queryName]" | "/queries/[queryName]/[item]"
type LayoutParams = RouteParams & { queryName?: string,item?: string }
